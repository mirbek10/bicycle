  ...
  return (
    <div className='grant'>
      ...
      <div className="grant-2 container">
        ...
        <p>Также, для удобства покупателей, наш магазин помогает (участвует) в формировании гарантийных запросов по всем нижеперечисленным брендам. При любом гарантийном случае можно обращаться напрямую к нам.</p>
      </div>
      <div className="grant-brands container">
        {
            GuaranteesBrand.map((item, index) =>(
